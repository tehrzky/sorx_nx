...
#define AVUTIL_SO_NAME      "libavutil.so"
#define AVCODEC_SO_NAME     "libavcodec.so"
#define AVFORMAT_SO_NAME    "libavformat.so"
#define AVFILTER_SO_NAME    "libavfilter.so"
#define AVDEVICE_SO_NAME    "libavdevice.so"
#define SWRESAMPLE_SO_NAME  "libswresample.so"
